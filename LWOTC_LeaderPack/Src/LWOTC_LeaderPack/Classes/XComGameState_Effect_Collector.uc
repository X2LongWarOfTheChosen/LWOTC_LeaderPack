...
function EventListenerReturn CollectionCheck(Object EventData, Object EventSource, XComGameState GameState, name EventID)
{
...
function Collector_BuildVisualization(XComGameState VisualizeGameState, out array<VisualizationActionMetadata> OutVisualizationTracks)
{
	local XComGameStateHistory				History;
    local XComGameStateContext_Ability		Context;
