...
function EventListenerReturn RemoveInvalidSoldiers(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
...
function EventListenerReturn ValidateDeployableSoldiersForOfficer(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
	local int idx;
...
function EventListenerReturn AddOfficerIcon_SquadSelectListItem(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
	local XComGameState_Unit Unit;
...
function EventListenerReturn SetDisabledOfficerListItems(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
	local XComGameState_HeadquartersXCom XComHQ;
...
function EventListenerReturn AddOfficerIcon_PersonnelListItem(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
	local XComGameState_Unit Unit;
...
function EventListenerReturn CheckOfficerMissionStatus(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
