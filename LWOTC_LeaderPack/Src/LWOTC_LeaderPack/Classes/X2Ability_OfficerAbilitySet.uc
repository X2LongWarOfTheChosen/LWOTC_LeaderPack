...
function FallBack_BuildVisualization(XComGameState VisualizeGameState, out array<VisualizationActionMetadata> OutVisualizationTracks)
{
...
function GetSome_BuildVisualization(XComGameState VisualizeGameState, out array<VisualizationActionMetadata> OutVisualizationTracks)
{
	local XComGameStateHistory				History;
    local XComGameStateContext_Ability		context;
    local StateObjectReference				InteractingUnitRef;
...
function OscarMike_BuildVisualization(XComGameState VisualizeGameState, out array<VisualizationActionMetadata> OutVisualizationTracks)
{
	local XComGameStateHistory				History;
    local XComGameStateContext_Ability		context;
    local StateObjectReference				InteractingUnitRef;
...
function FocusFire_BuildVisualization(XComGameState VisualizeGameState, out array<VisualizationActionMetadata> OutVisualizationTracks)
{
	local XComGameStateHistory				History;
    local XComGameStateContext_Ability		context;
    local StateObjectReference				InteractingUnitRef;
